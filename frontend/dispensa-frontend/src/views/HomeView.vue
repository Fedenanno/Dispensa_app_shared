  ...
  <div class="md:container md:mx-auto">
    ...
    <div v-show="authStore.user">
      <div class="grid gap-4 grid-cols-3 grid-rows-3 pt-6">
        ...
        <div @click="this.nuovaDipensa"
          class="bg-white dark:bg-slate-800 hover:bg-indigo-100 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
          <div>
            <span class="inline-flex items-center justify-center p-2 bg-indigo-500 rounded-md shadow-lg">
              <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" aria-hidden="true"></svg>
...
export default {
  ...
  methods: {
    ...
    apriDispensa(dispensa) {
      router.push({ name: 'dispenseHome', params: { id: dispensa } });
    }
